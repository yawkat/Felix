...
public interface DependencyResolutionStrategy {
     ...
     */
    public static final DependencyResolutionStrategy REGISTER = new DependencyResolutionStrategy() {
        @Override
        public void loadDependency(@NonNull ModuleManager moduleManager,
                                   @NonNull Class<?> dependency,
                                   @NonNull RegistrationProperties registrationProperties) {
            moduleManager.registerModule(dependency,
                                         registrationProperties.withDuplicateFinder(DuplicateFinder
                                                                                            .IGNORE_DUPLICATE_CLASSES)
            );
        }
    };
    /**
     ...
     */
    public static final DependencyResolutionStrategy FAIL = new DependencyResolutionStrategy() {
        @Override
        public void loadDependency(@NonNull ModuleManager moduleManager,
                                   @NonNull Class<?> dependency,
                                   @NonNull RegistrationProperties registrationProperties) {
     ...
     * @param registrationProperties The registration properties used. In most cases,
     *                               these should be used for further calls.
     */
